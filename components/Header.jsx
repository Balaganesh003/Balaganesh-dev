...
const Header = () => {
  return (
    <div data-aos="fade-right" data-aos-duration="1600" data-aos-delay="1100">
      <div className="">
        <h1 className="md:tracking-1 tracking-widest py-2 mt-8  text-[0.75rem] md:text-xs  text-HeadingGray uppercase">
          Hi, My name is
        </h1>
        ...
        <p className="text-base md:text-lg pr-1 lg:text-lg md:max-w-md lg:max-w-[33rem] text-HeadingGray font-medium mt-6">
          I am a Frontend Developer and Python Programmer. Constantly seeking
          new challenges and opportunities to enhance my skills. I am passionate
          about technology and always strive to stay updated with the latest
          industry trends.
        </p>
        <Link href="/contact">
          <button
