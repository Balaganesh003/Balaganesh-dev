...
const SkillItem = ({ skillName, percentage, skillStrength }) => {
  return (
    <div className=" hover:scale-105 hover:shadow-black hover:shadow-sm transition-all duration-200">
      <div
        data-aos="fade-up"
        data-aos-duration="1150"
        data-aos-once="true"
        data-aos-delay="200"
        className="flex flex-col group cursor-pointer  group border px-4 border-HeadingGray/50 rounded-xl py-2 ">
