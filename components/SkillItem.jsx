...
const SkillItem = ({ skillName, percentage, skillStrength }) => {
  return (
    <div
      ...
      data-aos-once="true"
      data-aos-delay="200"
      className="flex flex-col group cursor-pointer  group border px-4 border-HeadingGray/50 rounded-xl py-2 hover:scale-105 hover:shadow-black hover:shadow-sm transition-all duration-200">
